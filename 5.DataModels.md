...
![](5.DataModels_files/figure-html/unnamed-chunk-36-1.png)<!-- -->
...
![](5.DataModels_files/figure-html/unnamed-chunk-39-1.png)<!-- -->
...
![](5.DataModels_files/figure-html/unnamed-chunk-42-1.png)<!-- -->
...
![](5.DataModels_files/figure-html/unnamed-chunk-45-1.png)<!-- -->
...
data = cbind(data,y)
y.hat_mean <- model_data[indices,"mean"]
y.hat_lower <- model_data[indices,"X2.5."]
y.hat_upper <- model_data[indices,"X97.5."]
data
```
...
ggplot(data, aes(x = y, y = mean)) +  
  ...
  scale_x_continuous(limits = c(67000,120000), label=timeHMS_formatter, breaks = c(70000,80000,90000,100000,110000,120000)) +
  scale_y_continuous(limits = c(67000,120000), label=timeHMS_formatter, breaks = c(70000,80000,90000,100000,110000,120000)) +
